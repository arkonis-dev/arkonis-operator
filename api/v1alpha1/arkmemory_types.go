...
// ArkMemory defines the persistent memory backend for agent instances.
// Reference it from an ArkAgent via spec.memoryRef to give agents
...
func init() {
	SchemeBuilder.Register(&ArkMemory{}, &ArkMemoryList{})
}
